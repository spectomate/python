...
class PoetrySchema:
    ...
    @staticmethod
    def extract_dependencies(poetry_data: Dict[str, Any], include_dev: bool = False) -> List[str]:
        """
    ...
    @staticmethod
    def write_pyproject_toml(data: Dict[str, Any], output_path: Union[str, Path]) -> Path:
        """
    ...
    @staticmethod
    def convert_from_pip(pip_data: Dict[str, Any], project_name: str = "myproject", version: str = "0.1.0") -> Dict[str, Any]:
        """
